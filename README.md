...
[![rMF](http://pkg.julialang.org/badges/rMF_0.4.svg)](http://pkg.julialang.org/?pkg=rMF&ver=0.4) [![rMF](http://pkg.julialang.org/badges/rMF_0.5.svg)](http://pkg.julialang.org/?pkg=rMF&ver=0.5)

[![Build Status](https://travis-ci.org/madsjulia/rMF.jl.svg?branch=master)](https://travis-ci.org/madsjulia/rMF.jl)

[![Coverage Status](https://coveralls.io/repos/madsjulia/rMF.jl/badge.svg?branch=master)](https://coveralls.io/r/madsjulia/rMF.jl?branch=master)

This package provides methods for Robust Matrix Factorization.

rMF is a module of MADS.

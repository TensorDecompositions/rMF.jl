...
mixers_var = Array{Array{Float64, 2}}(maxbuckets)
buckets_var = Array{Array{Float64, 2}}(maxbuckets)
...
dict_species = DataStructures.OrderedDict{AbstractString,AbstractString}(
	...
	"Fraction Modern Carbon (de-normalized)"=>"14C",
	"Carbon-14 % Modern Carbon, De-normalized"=>"14C",
	"Dioxane[1,4-]"=>"Dioxane",
...
info("""rMF.loaddata("rdx-20170729")""")
info("""rMF.loaddata("rdx-20170823")""")
info("""rMF.loaddata("rdx-20171026")""")
info("rMF.execute(2:8; retries=64)")
